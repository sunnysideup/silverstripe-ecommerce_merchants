...
class MerchantAdminAccountPage extends Page
{
    ...
    public static $singular_name = 'Merchant Account Page';
    public function i18n_singular_name()
    {
        return _t('MerchantAdminAccountPage.SINGULARNAME', self::$singular_name);
    }

    public static $plural_name = 'Merchant Account Pages';
    public function i18n_plural_name()
    {
        return _t('MerchantAdminAccountPage.PLURALNAME', self::$plural_name);
    }
...
class MerchantAdminAccountPage_Controller extends Page_Controller
{
    ...
    public function notify($member, $type = "added", $error = false)
    {
