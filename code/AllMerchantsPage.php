...
class AllMerchantsPage extends ProductGroup
{
     ...
     * @var Array
     */
    public static $allowed_children = array('MerchantPage');

    /**
     * SS standard variable
     * @var String
     */
    public static $default_child = 'MerchantPage';
     ...
     * @var String
     */
    public static $singular_name = 'All Merchants Page';
    public function i18n_singular_name()
    {
        return _t('AllMerchantsPage.SINGULARNAME', self::$singular_name);
    }
    ...
    {
        return _t('AllMerchantsPage.PLURALNAME', self::$plural_name);
    }
     ...
     * @return String (HTML)
     */
    public function CategoryLink($categoryID, $fullLink = false)
    {
        $link = "";
        if ($fullLink) {
            $link .= "{$this->Link()}/?";
     ...
     * @return String (HTML)
     */
    public function MerchantPageLink($merchantPageID, $fullLink = false)
    {
        $link = "";
        if ($fullLink) {
            $link .= "{$this->Link()}/?";
     ...
     * @return String (HTML)
     */
    public function CityLink($cityID, $fullLink = false)
    {
        $link = "";
        if ($fullLink) {
            $link .= "{$this->Link()}/?";
     ...
     * @return String (HTML)
     */
    public function PriceFromLink($priceFrom, $fullLink = false)
    {
        $link = "";
        if ($fullLink) {
            $link .= "{$this->Link()}/?";
     ...
     * @return String (HTML)
     */
    public function PriceUpToLink($priceUpTo, $fullLink = false)
    {
        $link = "";
        if ($fullLink) {
            $link .= "{$this->Link()}/?";
...
class AllMerchantsPage_Controller extends ProductGroup_Controller
{
    ...
    public static function get_merchant_product_session_array_name()
    {
        return self::$merchant_product_session_array_name;
    }
    public static function set_merchant_product_session_array_name($s)
    {
        self::$merchant_product_session_array_name = $s;
    }

    protected static $ppp_param = 'ppp';
    public static function get_ppp_param()
    {
        return self::$ppp_param;
    }

    protected static $pos_param = 'pos';
    public static function get_pos_param()
    {
        return self::$pos_param;
    }

    protected static $category_param = 'category';
    public static function get_category_param()
    {
        return self::$category_param;
    }

    protected static $merchant_param = 'merchant';
    public static function get_merchant_page_param()
    {
        return self::$merchant_param;
    }

    protected static $city_param = 'city';
    public static function get_city_param()
    {
        return self::$city_param;
    }

    protected static $price_from_param = 'pricefrom';
    public static function get_price_from_param()
    {
        return self::$price_from_param;
    }

    protected static $price_upto_param = 'priceupto';
    public static function get_price_upto_param()
    {
        return self::$price_upto_param;
    }
    ...
    public function filter($data = null, $form = null)
    {
        //RETURN AJAX / NORMAL
        if (Director::is_ajax()) {
    ...
    public static function set_merchant_only_show_number_of_minutes($i)
    {
        self::$merchant_only_show_number_of_minutes = $i;
    }
    public static function get_merchant_only_show_number_of_minutes()
    {
        return self::$merchant_only_show_number_of_minutes;
    }
    ...
    public static function set_merchant_session_param($s)
    {
        self::$merchant_session_param = $s;
    }
    public static function get_merchant_session_param()
    {
        return self::$merchant_session_param;
    }
     ...
     */
    public function onlyshow($request = null)
    {
     ...
     * @param SS_HTTPRequest
     */
    public function clearonlyshow($request = null)
    {
        Session::set(self::get_merchant_session_param(), null);
        Session::set(self::get_merchant_session_param()."_time", null);
        Session::clear(self::get_merchant_session_param());
    ...
    public function showallonlyshowlinks()
    {
